...
class modMask4greece extends DolibarrModules
{
	...
	public function init($options = '')
	{
		...
		$result2=$extrafields->addExtraField('dalicence_plate', "Αρ. Οχήματος", 'select',  212, '', 'expedition',   0, 0, '', array('options'=>array('0'=>'-','1'=>'ΑΒΓ 1234','2'=>'ΔΕΖ 1234','3'=>'ΗΘΙ 1234','4'=>'ΚΛΜ 1234','5'=>'ΝΞΟ 1234')), 1,'', 1, 1, '', '1', '', '');
		$result3=$extrafields->update('dalicence_plate', "Αρ. Οχήματος", 'select',  '', 'expedition',   0, 0, 212, array('options'=>array('0'=>'-','1'=>'ΑΒΓ 1234','2'=>'ΔΕΖ 1234','3'=>'ΗΘΙ 1234','4'=>'ΚΛΜ 1234','5'=>'ΝΞΟ 1234')), 1,'', 1, "Eπιλέξτε όχημα", '', '', '', '');
		$result4=$extrafields->addExtraField('purpose', "Σκοπός διακίνησης", 'select',  213, '', 'expedition',   0, 0, '', array('options'=>array('0'=>'Πώληση','1'=>'Επισκευή','2'=>'Επιστροφή','3'=>'Συντήρηση')), 1,'', 1, 1, '', '1', '', '');
		$result5=$extrafields->update('purpose', "Σκοπός διακίνησης", 'select',  '', 'expedition',   0, 0, 213, array('options'=>array('0'=>'Πώληση','1'=>'Επισκευή','2'=>'Επιστροφή','3'=>'Συντήρηση')), 1,'', 1, "Eπιλέξτε σκοπό διακίνησης", '', '', '', '');
                $result6=$extrafields->addExtraField('shiptime', "Ώρα αποστολής", 'datetime', 214,  5, 'expedition',   0, 0, '', '', 1, '', 1, "Συμπληρώστε την ώρα αποστολής", '', '', '', '');
